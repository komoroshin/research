...
**⚠️ Частично действителен.** Карта горизонтальных игроков, некролог категории и пустой квадрант верны глобально (сведены в `00_core_findings.md` §1–4). Испанские нишевые игроки, интеграторы и каналы — привязаны к рынку, который отменён.
