...
export const WEEKS = {
  ...
  4: {
    ...
    queue: [
      ...
      { id: 'lactose', status: 'testing', order: 3, days: 'day 25–27' },
      { id: 'gos', status: 'queued', order: 4, days: 'day 31' },
    ...
    signals: {
      ...
      // 14 days of the fructans window. exposure = the group was eaten that day.
      series: [
        { day: 1, load: 2.1, exposure: null },
        { day: 2, load: 2.6, exposure: 0.7 },
        { day: 3, load: 6.4, exposure: null },
        { day: 4, load: 3.2, exposure: null },
        { day: 5, load: 2.4, exposure: 0.7 },
        { day: 6, load: 5.9, exposure: null },
        { day: 7, load: 2.8, exposure: null },
        { day: 8, load: 2.2, exposure: null },
        { day: 9, load: 2.5, exposure: 0.7 },
        { day: 10, load: 6.8, exposure: null },
        { day: 11, load: 3.4, exposure: null },
        { day: 12, load: 2.3, exposure: 0.7 },
        { day: 13, load: 5.6, exposure: null },
        { day: 14, load: 2.9, exposure: null },
      ],
    },
    map: {
      rows: [
  ...
  8: {
    ...
    queue: [
      { id: 'sorbitol', status: 'done', outcome: 'tolerated', order: 1, days: 'day 8–10' },
      { id: 'fructans', status: 'done', outcome: 'reacts', order: 2, days: 'day 14–16' },
      { id: 'lactose', status: 'done', outcome: 'threshold', order: 3, days: 'day 25–27' },
      { id: 'gos', status: 'done', outcome: 'tolerated', order: 4, days: 'day 33–35' },
      { id: 'fructose', status: 'done', outcome: 'undetermined', order: 5, days: 'day 41–43' },
    ],
    signals: {
      enough: true,
