...
(function (root) {
  ...
  const TOWN_NAMES = {
    ...
    conflux: ['Стихийный Круг', 'Четыре Ветра', 'Пламенный Исток', 'Грань Планов', 'Вихревой Дол', 'Светлый Ключ'],
    cove: ['Регна', 'Пиратская Бухта', 'Солёный Берег', 'Корабельный Мыс', 'Абордажная Гавань', 'Штормовой Риф'],
    factory: ['Литейный Двор', 'Паровая Слобода', 'Шестерёнка', 'Рудная Застава', 'Пороховой Стан', 'Медный Каньон'],
    hive: ['Гнездовье', 'Кладка', 'Хитиновый Курган', 'Сотовый Град', 'Ловчая Яма', 'Тронная Камера'],
    bastion: ['Бастион', 'Медвежий Угол', 'Оленья Застава', 'Волчий Частокол', 'Тихая Засека', 'Кабаний Брод'],
  };
