...
(function (root) {
  ...
  function armadillo(name, o) {
    ...
    const bodyS = [
      ...
      { p: [[56, 146], [58, 112], [74, 84], [100, 68], [118, 64], [118, 148], [86, 152]], c: S, m: 'horn', gloss: 0.6, tex: 'scale', texSize: 0.95, id: 'rear', belly: 0.3,
      ...
      ...[0, 1, 2, 3, 4, 5].map(i => {
        ...
        return { p: [[x0, top0], [x0 + 8, top0 - 3], [x1, top1], P(x1 + 1, 150, 1), P(x0, 150, 1)], c: i % 2 ? tone(S, 0.06) : S, m: 'horn', gloss: 0.6, belly: 0.35, line: 0.8, id: 'band' + i,
          lines: [{ p: [[x0 + 4, top0 + 4], [x0 + 5, 144]], w: 1.1, light: true, a: 0.45 }, { p: [[x0 + 12, top0 + 2], [x0 + 12, 146]], w: 0.9, a: 0.4 },
            ...[0, 1, 2, 3, 4].map(k => ({ p: [[x0 + 3, top0 + 16 + k * 16], [x0 + 8, top0 + 20 + k * 16], [x0 + 13, top0 + 16 + k * 16]], w: 0.9, a: 0.35 }))] };
      }),
      { p: [[200, 66], [222, 74], [240, 96], [246, 124], [238, 148], [200, 152]], c: S, m: 'horn', gloss: 0.6, tex: 'scale', texSize: 0.95, id: 'front', belly: 0.3,
    ...
    const headS = [
      ...
      { p: [[236, 112], [256, 108], [276, 118], [296, 136], [308, 150], [304, 158], [288, 158], [262, 152], [240, 146]], c: SK, m: 'skin', id: 'snout',
        lines: [{ p: [[276, 146], [300, 154]], w: 1.2, a: 0.6 }, { p: [[252, 134], [256, 146]], w: 1, a: 0.35 }, { p: [[260, 136], [263, 148]], w: 1, a: 0.3 }] },
      { e: [305, 151, 5, 4.5], c: '#3a2622', m: 'skin', line: 0.5, glint: [[304, 149, 1.4]] },
      // щиток на макушке
