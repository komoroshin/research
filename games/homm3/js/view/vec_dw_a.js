...
(function (root) {
  ...
  dw('bone_dragon', 7, G => {
    ...
    return [
      ...
      { e: [164, 174, 19, 14], c: '#1a1a1a', m: 'cloth', line: 1.1, sub: [{ e: [166, 176, 7, 6], c: NC.glow, m: 'flat', line: 0 }] },
      { e: [110, 206, 5, 3.5], c: '#1a1a1a', m: 'flat', line: 0 },
      // нижняя челюсть лежит перед пастью, зубы вверх
      { p: [P(64, G + 2, 1), [70, G - 16], P(96, G - 22, 1), [140, G - 20], P(182, G - 12, 1), P(186, G + 2, 1)], c: BD, m: 'horn', line: 1.2 },
      ...[84, 104, 124, 146].map(x => ({ p: [P(x - 5, G - 20, 1), P(x + 1, G - 36, 1), P(x + 6, G - 20, 1)], c: '#f4eed8', m: 'horn', line: 0.8 })),
