...
(function (root) {
  ...
  const RES = {
    ...
    mercury: () => [
      el(-38, -6, 11, 6, '#9ccde2', 'steel', { gloss: 1.3, glint: [[-41, -8, 2.8]] }), el(40, -6, 12, 6.5, '#9ccde2', 'steel', { gloss: 1.3, glint: [[37, -8, 3]] }), el(-50, -14, 5, 3.6, '#9ccde2', 'steel', { glint: [[-51, -15, 1.8]] }),
      sh(tube([[0, -34, 12], [0, -52, 10]], { flat1: true }), '#d6eef6', 'gem', { gloss: 1, line: 0.6 }),
      sh(box(-7, -60, 7, -50), '#9a6a3c', 'wood', { line: 0.6 }),
      el(0, -19, 22, 19, '#d6eef6', 'gem', { gloss: 1.2, rim: 0.8, line: 0.7, sub: [el(0, -6, 24, 13, '#7fb8d4', 'steel', { line: 0 })], glint: [[-8, -28, 4.5], [10, -10, 2]] })],
  ...
  for (const r of RES_IDS) obj('res_' + r, f => place(RES[r](), f.anchor[0], 122, 1));
  ...
  function mine(rid) {
    ...
    // вагонетка
    out.push(...place(RES[rid](), 244, 218, 0.72));
    ...
    out.push(...place(RES[rid](), 60, 288, 0.9));
    return out;
  }
  ...
  obj('pandora_box', () => {
    ...
    for (let i = 0; i < 5; i++) { const a = -Math.PI * (0.18 + i * 0.16), bx = 99 + (i - 2) * 22, L = i === 2 ? 76 : 62; out.push(sh([P(bx - 6, 84, 1), P(bx + Math.cos(a) * L - 8, 84 + Math.sin(a) * L, 1), P(bx + Math.cos(a) * L + 8, 84 + Math.sin(a) * L, 1), P(bx + 6, 84, 1)], i % 2 ? '#fff6c8' : '#ffe88a', 'gem', { line: 0, gloss: 0.6 })); }
  ...
  obj('keymaster', () => [
    ...
    sh(ring(206, 170, 16, 16, 7, 18), GOLD, 'gold', { line: 0.7 }),
    sh(tube([[214, 184, 8], [252, 222, 8]], { flat1: true }), GOLD, 'gold', { line: 0.7 }),
    sh([P(236, 214, 1), P(246, 204, 1), P(256, 214, 1), P(246, 224, 1)], GOLD, 'gold', { line: 0.6 }), sh([P(226, 204, 1), P(234, 196, 1), P(242, 204, 1), P(234, 212, 1)], GOLD, 'gold', { line: 0.6 }),
  ]);
  ...
  obj('border_guard', () => {
    ...
    out.push(el(150, 152, 26, 26, '$r:#e0b020', 'gold', { line: 0.8, lines: [ln(ell(150, 152, 19, 19, 16), 1.4, 0.5, { closed: true })], sub: [el(150, 146, 6, 6, DARK, 'flat', { line: 0 }), sh([P(147, 148, 1), P(153, 148, 1), P(155, 162, 1), P(145, 162, 1)], DARK, 'flat', { line: 0 })], glint: [[142, 144, 5]] }));
    return out;
  });
