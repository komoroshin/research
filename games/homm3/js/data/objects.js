...
(function (root) {
  ...
  const TYPES = {
    ...
    boat: { name: 'Лодка', sprite: 'boat', value: 800, once: null, enter: true, desc: 'Позволяет плыть по морю. Герой садится в неё с берега.' },
    shipyard: { name: 'Верфь', sprite: 'shipyard', value: 1500, once: null, desc: 'Строит лодку за 1000 золота.' },
    flotsam: { name: 'Обломки корабля', sprite: 'flotsam', value: 700, once: 'remove', sea: true, desc: 'Дерево и немного золота.' },
    sea_chest: { name: 'Сундук в воде', sprite: 'sea_chest', value: 1500, once: 'remove', sea: true, desc: 'Золото или артефакт.' },
    subter_gate: { name: 'Врата в подземелье', sprite: 'subter_gate', value: 900, once: null, enter: true, desc: 'Переносит героя на другой слой карты к парным вратам.' },
