...
(function (root) {
  ...
  const LIST = [
    ...
    { id: 'tactics', name: 'Тактика', value: [3, 5, 7], fmt: 'Перед боем можно переставить войска в полосе {v} гексов', w: { might: 4, magic: 2 } },
    { id: 'artillery', name: 'Артиллерия', value: [50, 75, 100], fmt: 'Баллиста бьёт вдвое с шансом {v} %; со 2 уровня — два выстрела; герой управляет ею', w: { might: 4, magic: 2 } },
    { id: 'ballistics', name: 'Баллистика', value: [1, 2, 3], fmt: 'Катапульта: прицельный выстрел / два выстрела / два с гарантированным попаданием', w: { might: 3, magic: 1 } },
