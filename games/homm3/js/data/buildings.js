...
(function (root) {
  ...
  const SPECIAL = {
    ...
    conflux: { name: 'Алтарь стихий', cost: { gold: 2000, wood: 5, ore: 5 }, desc: 'Каждый понедельник приносит 1–3 единицы случайного редкого ресурса.' },
    cove: { name: 'Маяк', cost: { gold: 2000, wood: 10 }, desc: 'Все ваши герои получают +400 очков движения в день.' },
    hive: { name: 'Инкубатор', cost: { gold: 2000, wood: 5, ore: 5, gems: 4 }, desc: 'Прирост существ 1–3 уровня в этом городе на 50 % больше.' },
    bastion: { name: 'Тотем охоты', cost: { gold: 2000, wood: 10, crystal: 3 }, desc: 'Первый визит героя даёт ему +1 к удаче навсегда.' },
    factory: { name: 'Литейный двор', cost: { gold: 2500, ore: 10, sulfur: 4 }, desc: 'Каждый понедельник существа из ваших внешних жилищ приходят в гарнизон этого города.' },
  };
