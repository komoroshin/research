/* ============================================================================
   data/factions.js — 13 фракций: местность, цвета, жилища 1–7 с ценами,
...
(function (root) {
  ...
  const LIST = [
    ...
    { id: 'rampart', name: 'Оплот', adj: 'Оплота', terrain: 'grass', color: '#3f9a3a', rare: 'crystal', guildMax: 5, alignment: 'good',
    ...
    { id: 'tower', name: 'Башня', adj: 'Башни', terrain: 'snow', color: '#8fb4e8', rare: 'gems', guildMax: 5, alignment: 'good',
    ...
    { id: 'necropolis', name: 'Некрополис', adj: 'Некрополиса', terrain: 'dirt', color: '#5a3a7a', rare: 'mercury', guildMax: 5, alignment: 'evil',
    ...
    { id: 'dungeon', name: 'Подземелье', adj: 'Подземелья', terrain: 'subter', color: '#8a2a2a', rare: 'sulfur', guildMax: 5, alignment: 'evil',
    ...
    { id: 'hive', name: 'Улей', adj: 'Улья', terrain: 'dirt', color: '#a8b02a', rare: 'gems', guildMax: 3, alignment: 'neutral',
      desc: 'Насекомые. Прирост вдвое выше обычного, но каждый по отдельности слаб: воюешь числом, а не качеством. Матка медленная, зато поднимает павших своих в личинок.',
      classes: ['swarmlord', 'pheromancer'], siloRes: { wood: 1, gems: 1 },
      dwellings: [d('Кладка', 400, 0, 5), d('Рабочий тоннель', 900, 5, 5), d('Кислотная яма', 1400, 5, 5), d('Осиное гнездо', 1500, 5, 5),
        d('Ловчая нора', 2000, 5, 5, { gems: 3 }), d('Панцирный курган', 2500, 5, 10), d('Тронная камера', 10000, 10, 10, { gems: 15 })] },
    { id: 'bastion', name: 'Бастион', adj: 'Бастиона', terrain: 'grass', color: '#7a5c2e', rare: 'crystal', guildMax: 3, alignment: 'neutral',
      desc: 'Лесной народ и приручённое зверьё. Звери быстрые и дешёвые, следопыты редкие и меткие; магии почти нет, зато вепрь разгоняется, росомаха отвечает дважды, а великий олень поднимает мораль.',
      classes: ['huntsman', 'totemist'], siloRes: { wood: 1, crystal: 1 },
      dwellings: [d('Кошачья опушка', 400, 5, 0), d('Сторожка следопытов', 1000, 5, 5), d('Кабанья чаща', 1500, 5, 5), d('Логово росомах', 1500, 5, 5),
        d('Дом ловчих', 2000, 10, 5, { crystal: 3 }), d('Медвежья берлога', 2500, 10, 10), d('Оленья поляна', 10000, 15, 10, { crystal: 15 })] },
