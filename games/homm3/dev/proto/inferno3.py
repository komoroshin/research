...
B.append(emit('hell_hound', c, 'адская гончая: графитовая шкура, огненная грива и хвост, светящаяся пасть', flipx=True))
...
B.append(emit('cerberus', c, 'цербер: три головы с горящими пастями, огненная грива и хвост', flipx=True))
