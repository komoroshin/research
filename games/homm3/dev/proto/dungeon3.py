...
B.append(emit('troglodyte', c, 'троглодит: безглазая морда, гребень на спине, светлое брюхо, дубина с шипами', flipx=True))
...
B.append(emit('manticore', c, 'мантикора: тёмная грива прядями, перепончатые крылья, хвост скорпиона с жалом', flipx=True))
...
B.append(emit('red_dragon', c, 'красный дракон: чешуя, золотое брюхо, два перепончатых крыла, огонь из пасти', flipx=True))
