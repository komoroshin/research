...
B.append(emit('armadillo', c, 'броненосец: панцирь пластинами, вытянутая морда, четыре лапы, хвост'))
...
B.append(emit('couatl', c, 'коатль: пернатый змей, золотые крылья веером, кольца тела чешуёй, гребень из перьев'))
