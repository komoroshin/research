...
out.write(emit('griffin', griffin, 'грифон: крыло рядами перьев, клюв с ноздрёй, когти по отдельности'))
...
out.write(emit('cavalier', cavalier, 'кавалерист: конь с гривой, попона с бахромой, всадник в латах, копьё'))
