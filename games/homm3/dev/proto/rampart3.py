...
B.append(emit('pegasus', c, 'пегас: белая лошадь, золотая грива, крыло веером перьев'))
...
B.append(emit('unicorn', c, 'единорог: белое тело, мятная грива прядями, витой золотой рог'))
...
B.append(emit('green_dragon', c, 'зелёный дракон: чешуя, перепончатое крыло, раскрытая пасть с клыками, гребень'))
