...
NUMBERS_VISION = dict(NUMBERS_GRID, **{
    ...
    "5,4": "ROG Partners 13-е изд.: медиана EV/EBITDA малых A/E-фирм (252 сделки); паспорт роллапа c1",
    "7,5": "ROG Partners: верхний квартиль EV/EBITDA малых инженерных фирм; паспорт роллапа c1",
    "10,75": "ACEC / Morrissey Goodale 2018–2023: EV/EBITDA, который платит private equity; паспорт роллапа c5",
    "7,34": "ACEC / Morrissey Goodale 2018–2023: EV/EBITDA, который платят публичные стратеги; паспорт роллапа c5",
    "10,8": "округление 10,75× (PE-покупатель), ACEC / Morrissey Goodale",
    "7,3": "округление 7,34× (стратег), ACEC / Morrissey Goodale",
    "0,1": "SPI/Kantata PS Maturity Benchmark 2026: рост EBITDA-маржи сектора 9,8 → 9,9%, п.п.; паспорт роллапа c2",
    "14,9": "Qualus → Clearlake, 25.03.2026: EV/EBITDA выхода; паспорт роллапа c4",
    "49": "NV5: число покупок до продажи за EV ~1,7 млрд $ (08.2025); паспорт роллапа",
