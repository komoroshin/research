...
// 3 · Как это работает
{
  ...
  cards(s, false, 2.35, 2.05, [
    ...
    { num: "3", head: "Проверка по нормам", txt: "База знаний хранит требования конкретной сетевой компании; замечания — инженеру на решение." },
...
// 5 · Запрос
{
  ...
  line(s, false, 4.65, 0.9, "Почему этап 2 — покупка фирм: продукт даёт долю гонорара, а фирма с продуктом внутри — весь гонорар и в полтора-два раза больше проектов. За такие фирмы стратеги платят по 445 тысяч $ за инженера (WSP → POWER). Это дистрибуция продукта, а не смена бизнеса.", { size: 13 });
...
// Источники
{
  ...
  const src = [
    ...
    "1,78 млрд $ / 4000 сотрудников — WSP → POWER Engineers, 10.2024; 445 тыс. $ за инженера = 1,78 млрд / 4000. Black & Veatch — вакансия 27.08.2026. Marengo, Vela — YC 2026.",
