...
// 2 · Кому и почём
{
  ...
  line(s, true, 4.85, 1.0, "Где: Персидский залив в первую очередь — там строят больше всего, не хватает проектировщиков с допуском сетевых компаний, Саудовская Аравия требует 30% местных инженеров, и туда нас пускают. Индия — как ресурсная база, а не как рынок сбыта. Рынок проектирования сетей только в Саудовской Аравии — порядка 450 млн $ в год; спрос дата-центров на электричество удваивается к 2030.", { size: 13 });
