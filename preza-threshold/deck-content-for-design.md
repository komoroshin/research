...
## Слайд 5 — Не диагноз и не лечение. Протокол с доказательной базой
...
- Вместо ложного дня протокол предлагает повторить — экран отбраковки в приложении A8
...
## Слайд 10 — Мы это уже построили. Сделаем снова — быстрее
...
## Слайд 11 — Движок один — протоколов будет много
...
## Слайд 12 — Протокол конечен. Продаём очередь протоколов, а не подписку
...
## Слайд 13 — $179 приносит $155 маржи. Дальше решает цена привлечения
...
## Слайд 14 — Инструменты для записи есть. Очередь никто не ведёт
...
| Threshold | несколько протоколов подряд в одной подписке *(строка подсвечена акцентом)* |

Рамка-акцент под таблицей с меткой «УНИКАЛЬНОСТЬ»:
> Эту позицию не занимает ни один игрок — ни трекеры, ни курсы, ни клиники

---

## Слайд 15 — Не строим, пока не проверим, дешевле ли $75–150 привести человека
...
## Слайд 16 — Вне регулирования FDA — граница известна и встроена в продукт
...
## Слайд 17 — Три риска и механизм по каждому
...
## Слайд 18 — Покупатель для этого существует: четыре сделки рядом с нами

Таблица (сделка → параметры):
| | |
|---|---|
...
## Слайд 19 — Возврат: вложить ~$1,5M за 36 месяцев, продаться за $5–10M
...
## Слайд 20 — $165k, два этапа фиксированной ценой
